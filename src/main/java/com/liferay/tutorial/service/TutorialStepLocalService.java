...
/**
 * Provides the local service interface for TutorialStep. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Miroslav Ligas
 * @see TutorialStepLocalServiceUtil
...
public interface TutorialStepLocalService extends BaseLocalService,
    InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link TutorialStepLocalServiceUtil} to access the tutorial step local service. Add custom service methods to {@link com.liferay.tutorial.service.impl.TutorialStepLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
